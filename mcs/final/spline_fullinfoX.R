...
N <- 20
T_int <- c(100,250)
file_name <- "./results/temp_spline_fullinfoX.Rda"
...
file_name <- "./results/final_spline_fullinfoX.Rda"
...
scatter <- ggplot(ss,aes(x=thh.Theta.1.,y=thh.Theta.2., color=factor(T)))+geom_point(alpha=0.06)+
