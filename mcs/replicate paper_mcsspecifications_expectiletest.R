...
# full version
N <- 2000
file_name <- "./results/save_expectiles.Rda"


#fast version
 # N <- 100
 # file_name <- "./results/temp_expectiles.Rda"
...
simulate(save_to = file_name,
         ...
         tests = list(
           ...
           list(iden.fct = "expectile_model",model = "periodic", instruments="forecast"),
           list(iden.fct = "expectile_model",model = "break_logit_const", instruments ="forecast")
         ),forecasters = list(
